...
def linear_fuel(crabs):
    ...
    def _linear_fuel(to_pos):
        """Calculate total fuel needed to move to a given position, each step costs 1 fuel"""
...
def triangular_fuel(crabs):
    ...
    def _triangular_fuel(to_pos):
        """Calculate total fuel needed to move to a given position, each step costs 1 extra fuel"""
        return sum(
